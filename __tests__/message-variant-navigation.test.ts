  ...
  test("Should show correct variant count for specific message", () => {
    ...
    const messages = [
      ...
      // Branch 1: retry of ai1
      {
        ...
        body: "response1_v2",
        messageType: "assistant",
        conversationBranchId: "branch_ai1_1750046000000_abc",
        branchPoint: "user1",
        timestamp: 1002,
      },
      ...
      // Branch 2: retry of ai1 again
      {
        ...
        body: "response1_v3",
        messageType: "assistant",
        conversationBranchId: "branch_ai1_1750046001000_def",
        branchPoint: "user1",
        timestamp: 1003,
      },
      ...
      // Branch 3: retry of ai1 again
      {
        ...
        body: "response1_v4",
        messageType: "assistant",
        conversationBranchId: "branch_ai1_1750046002000_ghi",
        branchPoint: "user1",
        timestamp: 1004,
      },
      ...
      // Branch 4: retry of ai1 again
      {
        ...
        body: "response1_v5",
        messageType: "assistant",
        conversationBranchId: "branch_ai1_1750046003000_jkl",
        branchPoint: "user1",
        timestamp: 1005,
      },
      ...
      // Branch 5: retry of ai2 (the new assistant message)
      {
        ...
        body: "response2_v2",
        messageType: "assistant",
        conversationBranchId: "branch_ai2_1750046004000_mno",
        branchPoint: "user2",
        timestamp: 1008,
      },
    ]
    ...
    const findMessageVariants = (targetMessageId: string) => {
      ...
      console.log(
        `Finding variants for ${targetMessageId}, user message: ${userMessage._id}`,
      )
    ...
    expect(ai1Variants.map((v) => v._id)).toEqual([
      "ai1",
      "ai1_retry1",
      "ai1_retry2",
      "ai1_retry3",
    ...
    console.log(
      "AI2 message:",
      messages.find((m) => m._id === "ai2"),
    )
    console.log(
      "AI2 variants found:",
      ai2Variants.map((v) => ({ id: v._id, branchPoint: v.branchPoint })),
    )
    ...
    console.log(
      "AI2 retry variants:",
      ai2RetryVariants.map((v) => ({ id: v._id, branchPoint: v.branchPoint })),
    )
    expect(ai2RetryVariants).toHaveLength(2)
    const ai2RetryIndex = ai2RetryVariants.findIndex(
      (v) => v._id === "ai2_retry1",
    )
    ...
    console.log(
      "AI1 variants:",
      ai1Variants.length,
      ai1Variants.map((v) => v.body),
    )
    console.log(
      "AI2 variants:",
      ai2Variants.length,
      ai2Variants.map((v) => v.body),
    )
    console.log(
      "AI2 retry navigation:",
      `${ai2RetryIndex + 1}/${ai2RetryVariants.length}`,
    )
  })
})
