...
import { SMOOTH_TEXT_PRESETS, useSmoothText } from "@/hooks/useSmoothText";
...
export function HTTPStreamingMessage({
	...
	const { streamingMessage, isStreaming, error, sendMessage, clearError } =
		...
		<div className={`space-y-4 ${className}`}>
			...
			<div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
				...
				<p className="text-sm text-blue-700">
					...
					optimized database writes. Compare performance with standard real-time
					streaming.
				</p>
					...
					<div className="grid grid-cols-2 gap-4 text-sm">
						...
						<div>
							...
							<div className="text-xs text-green-500">
								{Math.round(
									(1 -
										Math.ceil(streamingMessage.body.length / 50) /
