...
import { MODELS, getModelsForProvider, DEFAULT_MODEL_ID } from "./schemas"
import type { ModelConfig, ModelId, ModelProvider } from "./schemas"
...
export const OPENROUTER_MODELS: Record<string, ModelConfig> = Object.fromEntries(
